...
public class Constants {
    public static final String SERVER_IP = "10.61.113.206";// 服务器ip,要改
    public static final int SERVER_PORT = 6666;// 服务器端口

    public static final int REGISTER_FAIL = 0;//注册失败
    public static final String ACTION = "com.swufe.czj.imitateqq.CUSTOM_BROADCAST";//消息广播action
